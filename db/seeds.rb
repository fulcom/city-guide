...
maxime.save
# participant
isabelle = User.new(first_name: "Isabelle", last_name: "Leclaire", city: "Paris", email: "isabell@gmail.com", password: "123456", photo: "https://avatars2.githubusercontent.com/u/49897862?v=4")
isabelle.save


# trips
montmartre = Trip.new(name: "Ballade à Montmartre", city: "Paris", address: "16 villa Gaudelet, Paris", user_id: "1", description: "Claire est rédactrice pour le site montmartre-site.com
